...
See the **Features** documentation for the capabilities supported by MDCS.
...
- Lack of a unified way to manage personal devices.

MDCS aims to make multiple devices work together as a single coordinated system.

## Vision
To become a personal operating layer that enables a user's devices to behave as a unified system 
rather than independent machines.
